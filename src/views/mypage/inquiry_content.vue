<template>
    ...
    <div class="form-control" id="background">
     <form id="sendForm" >
        <div class="content" v-for="item in content" :key="item.QUESTION_NUMBER">
             <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="writer" class="col-sm-2 col-form-label">제목</label>
                    <textarea class="text2" :disabled="editable === false" v-model="content[0].QUESTION_TITLE"
                  style="font-size: 17px;"></textarea>
                </div>
              <div class="mb-3">
                  <label for="content" class="form-label" >내용<span>*</span></label>
                  <textarea class="text1" :disabled="editable === false" v-model="content[0].QUESTION_CONTENT"
                          style="font-size: 17px;"></textarea>
              </div>
              ...
              <div class="right_btn" style="margin-top:100px;">
                    <button type="button" class="btn btn-warning" @click="editContent()" v-if="editable === false">수정완료</button>
                          ...
                          <button type="button" class="btn btn-secondary" @click="confirmDeleteContent(item.QUESTION_NUMBER)">삭제</button>
                        </div>
        </div> 
              ...
              <div class="area" v-for="(qna,i) in content" :key="i">
                <form v-if="qna.QUESTION_ANSWER != null">
                  <label class="head_answer" style="font-size: 17px; font-weight: bold;">답변</label>
                    ...
                    <textarea class="text3" v-model="qna.QUESTION_ANSWER" style="font-size: 17px;" readonly></textarea>
